...
#ifndef DEMOS_ANDROID_PERFTEST_SRC_MAIN_JNI_TT_TEXT_MANAGER_H_
#define DEMOS_ANDROID_PERFTEST_SRC_MAIN_JNI_TT_TEXT_MANAGER_H_
...
#endif  // DEMOS_ANDROID_PERFTEST_SRC_MAIN_JNI_TT_TEXT_MANAGER_H_
