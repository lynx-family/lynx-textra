 ...
 */
#ifndef PUBLIC_TEXTRA_PLATFORM_JAVA_SCOPED_GLOBAL_REF_H_
#define PUBLIC_TEXTRA_PLATFORM_JAVA_SCOPED_GLOBAL_REF_H_
#include <jni.h>
...
#endif  // PUBLIC_TEXTRA_PLATFORM_JAVA_SCOPED_GLOBAL_REF_H_
