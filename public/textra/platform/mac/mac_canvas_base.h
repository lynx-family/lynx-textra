...
// in the LICENSE file.
//
// Created by wenhe on 2020/11/24.
//

#ifndef PUBLIC_TEXTRA_PLATFORM_MAC_MAC_CANVAS_BASE_H_
#define PUBLIC_TEXTRA_PLATFORM_MAC_MAC_CANVAS_BASE_H_
...
class IOSCanvasBase : public tttext::ICanvasHelper {
 public:
  IOSCanvasBase() { context_ = [[NSGraphicsContext currentContext] CGContext]; }
...
#endif  // PUBLIC_TEXTRA_PLATFORM_MAC_MAC_CANVAS_BASE_H_
