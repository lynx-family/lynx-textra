...
#ifndef SRC_TEXTLAYOUT_UTILS_TYPE_HELPER_H_
#define SRC_TEXTLAYOUT_UTILS_TYPE_HELPER_H_
...
ANDROID_BASIC_TYPES_TRAITS(int16_t)
ANDROID_BASIC_TYPES_TRAITS(uint16_t)
ANDROID_BASIC_TYPES_TRAITS(int32_t)
ANDROID_BASIC_TYPES_TRAITS(uint32_t)
// ANDROID_BASIC_TYPES_TRAITS(int32_t)
// ANDROID_BASIC_TYPES_TRAITS(unsigned long)
ANDROID_BASIC_TYPES_TRAITS(int64_t)
ANDROID_BASIC_TYPES_TRAITS(uint64_t)
...
template <typename TYPE>
inline void copy_type(TYPE* d, const TYPE* s, size_t n) {
...
template <typename TYPE>
inline void move_forward_type(TYPE* d, const TYPE* s, size_t n = 1) {
...
template <typename TYPE>
inline void move_backward_type(TYPE* d, const TYPE* s, size_t n = 1) {
  if ((traits<TYPE>::has_trivial_dtor && traits<TYPE>::has_trivial_copy) ||
      traits<TYPE>::has_trivial_move) {
    memmove(d, s, n * sizeof(TYPE));
  } else {
...
template <typename T>
inline hash_t hash_type(const T* const& value) {
...
#endif  // SRC_TEXTLAYOUT_UTILS_TYPE_HELPER_H_
