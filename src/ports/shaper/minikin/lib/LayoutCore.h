...
#include "lib/Hyphenator.h"
#include "lib/MinikinExtent.h"
#include "lib/MinikinFont.h"
#include "lib/MinikinRect.h"
#include "lib/Range.h"
...
public:
    ...
    const std::vector<uint32_t>& glyphIndices() const {return mGlyphIndices;}
...
//    FRIEND_TEST(LayoutTest, doLayoutWithPrecomputedPiecesTest);
    ...
    std::vector<uint32_t> mGlyphIndices;// per glyph
