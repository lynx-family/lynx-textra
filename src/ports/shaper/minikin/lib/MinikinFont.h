...
class MinikinFont {
 public:
  ...
  virtual uint16_t UnicodeToGlyph(uint32_t codepoint,
                                  uint32_t variationSelector) const = 0;

  virtual void GetFontInfo(TTFontInfo& info, float font_size) const = 0;
